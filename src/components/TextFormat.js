    ...
    return (
        <>
            <div className="container">
                ...
                <div className="mb-2 ">
                    <textarea className={`form-control no-resize  ${props.mode === 'dark' ? 'dark-placeholder' : 'light-placeholder'}`} id="textBox" rows="12" onChange={OnChange} value={text} placeholder='Enter Text Here...' style={{ backgroundColor: props.mode === 'dark' ? 'rgb(48 48 50)' : '#f9f9f9', color: props.mode === 'dark' ? '#f3f3f3' : '#45474B' }}></textarea>
                </div>
